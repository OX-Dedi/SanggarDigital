...
$kelas_result = mysqli_query($conn, "SELECT id, nama_kelas FROM kelas WHERE guru_id = $user_id");
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  form {
    ...
    padding: 40px 50px;
    border-radius: 16px;
    box-shadow: 0 4px 20px rgba(0, 188, 212, 0.15), inset 0 0 15px #00BCD4;
    transition: box-shadow 0.3s ease;
  }
  form:hover {
    box-shadow: 0 6px 30px rgba(0, 188, 212, 0.3), inset 0 0 20px #00BCD4;
  }
  h2 {
    font-weight: 700;
    font-size: 2rem;
